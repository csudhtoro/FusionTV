...
//import static com.example.fusiontv.utils.MyUtilities.UpdateAllFavoritesDaily;
//import static com.example.fusiontv.utils.MyUtilities.UpdateAllNotifsDaily;
import static com.example.fusiontv.fragments.NotificationFragment.UpdateAllFavoritesDaily;
...
public class DashboardFragment extends Fragment implements OnShowListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(checkUserLoggedIn(currUser)) {
            ...
            DatabaseReference db2 = FirebaseDatabase.getInstance().getReference("Users").child(getCurrUserId()).child("Notifications");
            //dailyFavoritesCheck(db, db2);
        }
