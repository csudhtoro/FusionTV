...
public class RealityViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public RealityViewHolder(@NonNull View itemView, OnShowListener onShowListener) {
        super(itemView);
