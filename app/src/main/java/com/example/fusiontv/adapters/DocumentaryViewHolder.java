...
public class DocumentaryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public DocumentaryViewHolder(@NonNull View itemView, OnShowListener onShowListener) {
        super(itemView);
