...
public class ActionAdventureViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ActionAdventureViewHolder(@NonNull View itemView, OnShowListener onShowListener) {
        super(itemView);
