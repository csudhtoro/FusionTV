...
public class SoapViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public SoapViewHolder(@NonNull View itemView, OnShowListener onShowListener) {
        super(itemView);
