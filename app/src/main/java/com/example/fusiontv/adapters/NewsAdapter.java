...
public class NewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewsAdapter(OnShowListener onShowListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NewsViewHolder(view, onGenreListener);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((NewsViewHolder)holder).title.setText(mData.get(position).getName());
        Glide.with(((NewsViewHolder) holder).itemView.getContext())
