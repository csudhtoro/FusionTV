...
public class Profile implements Parcelable
{
    ...
    public final static Creator<Profile> CREATOR = new Creator<Profile>() {
        ...
        public Profile createFromParcel(android.os.Parcel in) {
    ...
    protected Profile(android.os.Parcel in) {
     ...
     * @param height
     */
    public Profile(Double aspectRatio, Integer height, Object iso6391, String filePath, Double voteAverage, Integer voteCount, Integer width) {
        super();
